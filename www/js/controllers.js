...
(function() {
  var app, chunk, dataURItoBlob, uniq, uniqueObjects,
  ...
  app.controller('ReviewCtrl', [
    "$scope", "$ionicPopup", "askiiUrl", "askiiKey", "$http", "$rootScope", function($scope, $ionicPopup, askiiUrl, askiiKey, $http, $rootScope) {
      var userId;
      ...
      $http.get(askiiUrl + '/questions?key=' + askiiKey + '&creator=' + userId).success(function(data, status, headers, config) {
        ...
        organizedBooks = function(allQuestions) {
          var bookObj, bookTitle, k, len1, organizedByBook, question, ref;
          organizedByBook = {};
          ...
          for (bookTitle in organizedByBook) {
            bookObj = organizedByBook[bookTitle];
      ...
      return $scope.showPopup = function(vocab) {
        var alertPopup, fill_in_text, length_selected_word, question_string, splitQuestion;
